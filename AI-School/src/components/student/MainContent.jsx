...
const MainContent = ({ enrolledCourses }) => {
  ...
  const scroll = (direction) => {
    ...
    } else if (direction === "right" && (currentPage + 1) * coursesPerPage < enrolledCourses.length) {
      setCurrentPage(currentPage + 1);
    }
  };
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="p-2 bg-gray-200 rounded-full hover:bg-gray-300 disabled:opacity-50"
            disabled={(currentPage + 1) * coursesPerPage >= enrolledCourses.length}
          >
              ...
              <div className="w-[70%]">
                    <p className="text-sm mb-6">
                      {course.shortDescription.split(' ').length > 20 
                        ? course.shortDescription.split(' ').slice(0, 20).join(' ') + '...'
