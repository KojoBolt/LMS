...
import { Home, BookOpen, Compass, Calendar, Users, Gift, Bug, Bell, EllipsisVertical, UserPlus } from "lucide-react";
...
const menu = [
  ...
  { icon: <UserPlus size={18} />, label: "Add User", path: "/admin/add-user" },
