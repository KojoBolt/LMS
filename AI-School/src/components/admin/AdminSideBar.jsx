...
const menu = [
    { icon: <Home size={18} />, label: "Home", path: "/admin/dashboard" },
    { icon: <BookOpen size={18} />, label: "My Courses", path: "/admin/courses" },
    { icon: <UsersRound size={18} />, label: "Student Enrollment", path: "/admin/enrollments" },
            ...
            <div className="relative" ref={popupRef}>
                ...
                {isPopupOpen && (
                    <div className="absolute bottom-full mb-2 right-0 w-56 bg-white rounded-lg shadow-xl border border-gray-200 p-2">
                        <Link to="/admin/profile" className="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
