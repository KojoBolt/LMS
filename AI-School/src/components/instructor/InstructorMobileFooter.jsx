...
const mainAdminMenuItems = [
    { icon: <LayoutDashboard size={24} />, label: "Dashboard", path: "/instructor/dashboard" },
    { icon: <BookOpen size={24} />, label: "Upload-Courses", path: "/instructor/courses" },
...
const moreMenuItems = [
    ...
    { icon: <Settings size={18} />, label: "Profile", path: "/instructor/profile" },
];

const InstructorMobileFooter = () => {
...
export default InstructorMobileFooter;
